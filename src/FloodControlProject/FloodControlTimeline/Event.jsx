            ...
            <div>
                <div className={idx % 2 === 0 ? "flex flex-row-reverse justify-between" : "flex flex-row justify-between"}>
                    ...
                    <div>
                        ...
                        <h1 className={idx % 2 === 0 ? "text-left text-xl mt-2 italic mr-0" : "text-right text-xl mt-2 italic mr-0"}>{eventHeading}</h1>
                    </div>
                </div>
                <div className={idx % 2 === 0 ? "flex justify-start" : "flex justify-end"}>
                    <img src={gif} alt={eventTitle} className="scale-[1.3] align-center p-8"/>
                </div>
                <p className={idx % 2 === 0 ? "w-full mx-auto mt-6 text-left text-lg pr-48" : "w-full mx-auto mt-6 text-right text-lg pl-48"}>{eventDescription}</p>
            </div>
        </>
    )
}
